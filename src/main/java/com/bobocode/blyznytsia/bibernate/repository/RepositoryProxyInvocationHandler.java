...
public class RepositoryProxyInvocationHandler<T> implements InvocationHandler {
  ...
  public Object invoke(Object proxy, Method method, Object[] params) {
    ...
    if (returnType.equals(Optional.class)) {
      ...
      throw new RepositoryException("Return type %s not supported".formatted(returnType.getSimpleName()));
    }
  }
  ...
  private Query<T> buildNativeQuery(Method method, Object[] params) {
    ...
    if (params.length != query.getParamsCount()) {
      throw new RepositoryException("count of parameters does not matches count method arguments");
    }
